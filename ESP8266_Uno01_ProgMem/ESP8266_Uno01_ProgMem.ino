...
void HTML_Make_Content() {
  ...
  HTML_Send_PROGMEM(F("<HTML><HEAD> <title>SMC Luefter Steuerung</title></HEAD>\n"));

  HTML_Send_PROGMEM(F("<BODY bgcolor=\"#ADCEDE\" text=\"#000000\">"));

  HTML_Send_PROGMEM(F("<FONT size=\"6\" FACE=\"Verdana\">SMC Luefter Steuerung<BR/></FONT>"));
 ...
 HTML_Send_PROGMEM(F("Leistung:<INPUT NAME=\"PULS\" TYPE=\"TEXT\" size=\"3\" MAXLENGTH=\"3\" VALUE=\""));
...
//--------------------------------------------------------------------
void Led_Handling() {
FanSpeed = map(led_pulsdauer, 0, 100, 0, 255);  
